...
'' nRF24L01 Instruction Definitions */
  WRITE_REG     = 0x20  '''' Register write command */
  RD_RX_PLOAD_W = 0x60  '''' Read RX payload command */
  RD_RX_PLOAD   = 0x61  '' Read RX payload command */
  WR_TX_PLOAD   = 0xA0  '' Write TX payload command */
  WR_ACK_PLOAD  = 0xA8  '' Write ACK payload command */
  WR_NAC_TX_PLOAD = 0xB0  '' Write ACK payload command */
  FLUSH_TX      = 0xE1  '' Flush TX register command */
  FLUSH_RX      = 0xE2  '' Flush RX register command */
  REUSE_TX_PL   = 0xE3  '' Reuse TX payload command */
  LOCK_UNLOCK   = 0x50  '' Lock/unlcok exclusive features */

  NOP           = 0xFF  '' No Operation command, used for reading status register */

''/** @name  - Register Memory Map - */
'' nRF24L01 * Register Definitions * */
  CONFIG        = 0x00  '' nRF24L01 config register */
  EN_AA         = 0x01  '' nRF24L01 enable Auto-Acknowledge register */
  EN_RXADDR     = 0x02  '' nRF24L01 enable RX addresses register */
  SETUP_AW      = 0x03  '' nRF24L01 setup of address width register */
  SETUP_RETR    = 0x04  '' nRF24L01 setup of automatic retransmission register */
  RF_CH         = 0x05  '' nRF24L01 RF channel register */
  RF_SETUP      = 0x06  '' nRF24L01 RF setup register */
  STATUS        = 0x07  '' nRF24L01 status register */
  OBSERVE_TX    = 0x08  '' nRF24L01 transmit observe register */
  CD            = 0x09  '' nRF24L01 carrier detect register */
  RX_ADDR_P0    = 0x0A  '' nRF24L01 receive address data pipe0 */
  RX_ADDR_P1    = 0x0B  '' nRF24L01 receive address data pipe1 */
  RX_ADDR_P2    = 0x0C  '' nRF24L01 receive address data pipe2 */
  RX_ADDR_P3    = 0x0D  '' nRF24L01 receive address data pipe3 */
  RX_ADDR_P4    = 0x0E  '' nRF24L01 receive address data pipe4 */
  RX_ADDR_P5    = 0x0F  '' nRF24L01 receive address data pipe5 */
  TX_ADDR       = 0x10  '' nRF24L01 transmit address */
  RX_PW_P0      = 0x11  '' nRF24L01 \# of bytes in rx payload for pipe0 */
  RX_PW_P1      = 0x12  '' nRF24L01 \# of bytes in rx payload for pipe1 */
  RX_PW_P2      = 0x13  '' nRF24L01 \# of bytes in rx payload for pipe2 */
  RX_PW_P3      = 0x14  '' nRF24L01 \# of bytes in rx payload for pipe3 */
  RX_PW_P4      = 0x15  '' nRF24L01 \# of bytes in rx payload for pipe4 */
  RX_PW_P5      = 0x16  '' nRF24L01 \# of bytes in rx payload for pipe5 */
  FIFO_STATUS   = 0x17  '' nRF24L01 FIFO status register */
  DYNPD         = 0x1C  '' nRF24L01 Dynamic payload setup */
  FEATURE       = 0x1D  '' nRF24L01 Exclusive feature setup */
